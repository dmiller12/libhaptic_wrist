...
TEST_F(KinematicsTest, ForwardKinematicsAtKnownPositions) {
    ...
    std::array<Kin, 3> kin_zero = kinematics->eval(pos_at_zero);
    Eigen::Matrix4d T_tool_zero = kin_zero[2].to_world_frame;
    ...
    std::array<Kin, 3> kin_j1_90 = kinematics->eval(pos_j1_90);
    Eigen::Matrix4d T_tool_j1_90 = kin_j1_90[2].to_world_frame;
