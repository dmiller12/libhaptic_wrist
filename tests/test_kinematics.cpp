...
TEST_F(KinematicsTest, ForwardKinematicsAtKnownPositions) {
    ...
    auto kin_zero = kinematics->eval(pos_at_zero);
    Eigen::Matrix4d T_tool_zero = kin_zero[haptic_wrist::kWristDofs].to_world_frame;

    Eigen::Matrix4d T_expected_zero;
    T_expected_zero << 0, 0, -1, 0.068155,
                       0, 1, 0, 0,
                       1, 0, 0, 0.1617,
                       0, 0, 0, 1;
    ...
    // test j1 90 degrees
    jp_type pos_j1_90;
    pos_j1_90 << M_PI / 2.0, 0.0, 0.0, 0.0;

    auto kin_j1_90 = kinematics->eval(pos_j1_90);
    Eigen::Matrix4d T_tool_j1_90 = kin_j1_90[haptic_wrist::kWristDofs].to_world_frame;
