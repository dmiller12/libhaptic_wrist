...
//             // 3. Get Cartesian torque command from the orientation controller
//             ct_type cartesian_torque = orientation_controller_->compute_torque(
//                 desired_orientation, current_orientation, tool_vel_base_frame);

//             // 4. Map Cartesian torque to joint torques using Jacobian transpose
//             total_joint_torques += J_omega.transpose() * cartesian_torque;
//         }
